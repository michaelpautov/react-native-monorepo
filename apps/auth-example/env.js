 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.apps/auth-example.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.auth.example'; // ios bundle id
const PACKAGE = 'com.auth-example'; // android package name
const NAME = 'auth.example'; // app name
const EXPO_ACCOUNT_OWNER = 'mpautov'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'com.auth.example'; // app scheme
